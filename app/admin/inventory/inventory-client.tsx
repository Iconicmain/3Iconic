...
export function InventoryStationPage({
  ...
  const [inventoryItems, setInventoryItems] = useState<{ id: string; itemName: string; quantityAvailable: number; itemCode?: string; category?: string; minimumLevel: number; unitType?: string }[]>([]);
